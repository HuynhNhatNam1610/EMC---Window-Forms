...
namespace EMC.UI.Forms
{
    partial class fResult
    {
        ...
        private void InitializeComponent()
        {
            ...
            rcbFilter.Location = new Point(825, 11);
            ...
            rbtnSearch.Image = (Image)resources.GetObject("rbtnSearch.Image");
            ...
            rbtnVoice.Image = (Image)resources.GetObject("rbtnVoice.Image");
            ...
            dgvSamples.Columns.AddRange(new DataGridViewColumn[] { sampleId, contractCode, sampleCode, customerName, Email, sodienthoai, status, updateAt, confirmed_date, dataGridViewButtonColumn1 });
        ...
        private Controls.RoundedComboBox rcbFilter;
